...
urlpatterns = [
    ...
    path("projects/project/create/<int:project_id>/requirements/update", login_required(ProjectCreateView.as_view()), name='requirement-update'),
    path("projects/project/create/<int:project_id>/requirements/delete", login_required(ProjectCreateView.as_view()), name='requirement-delete'),
    #---------------- Company -------------
